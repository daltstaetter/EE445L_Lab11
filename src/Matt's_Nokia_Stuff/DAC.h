...
// LCD 
#define RST								GPIO_PIN_4  // (Pin5) Active low
#define LCD_EXTENDED_CMD	0x21        // uses extended instruction set
#define LCD_BASIC_CMD			0x20				// uses normal instruction set
#define LCD_BIAS_MODE_0		0x14				// biase mode 1:40, not sure what this really means
#define CONTRAST_DEFAULT 	0xB8				// set LCD Vop (contrast)
#define TEMP_COEFF				0x04				// set temp coeff
#define SCE								GPIO_PIN_3  // Chip Enable Bit
...
//*********Nokia5110_DrawMap***********************
//compares the level to the current mapping and outputs the course or the youwin screen to the LCD
//inputs:		map two dimensional array of the current level
//					level what level the player is playing
//outputs:	none
