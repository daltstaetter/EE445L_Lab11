...
#define FALSE     0
//------------------------------------------------------------------------------------------
extern long XLangleX;
extern long XLangleY;
extern long XLangleZ;
...
extern short gx, gy, gz; // x, y, and z axis readings of the gyroscope
extern short ax, ay, az; // x, y, and z axis readings of the accelerometer
extern short mx, my, mz; // x, y, and z axis readings of the magnetometer
...
//LSM9DS0(unsigned char gAddr, unsigned char xmAddr);

// begin(void) -- Initialize the gyro, accelerometer, and magnetometer.
...
// All parameters have a defaulted value, so you can call just "begin(void)".
...
unsigned short begin(enum gyro_scale gScl, enum accel_scale aScl, enum mag_scale mScl, enum gyro_odr gODR, enum accel_odr aODR, enum mag_odr mODR);
//gScl = G_SCALE_245DPS
//aScl = A_SCALE_2G
//mScl = M_SCALE_2GS
...
// readGyro(void) -- Read the gyroscope output registers.
// This function will read all six gyroscope output registers.
// The readings are stored in the class' gx, gy, and gz variables. Read
// those _after_ calling readGyro(void).
void readGyro(void);

// readAccel(void) -- Read the accelerometer output registers.
// This function will read all six accelerometer output registers.
// The readings are stored in the class' ax, ay, and az variables. Read
// those _after_ calling readAccel(void).
void readAccel(void);

// readMag(void) -- Read the magnetometer output registers.
// This function will read all six magnetometer output registers.
// The readings are stored in the class' mx, my, and mz variables. Read
// those _after_ calling readMag(void).
void readMag(void);

// calcGyro(void) -- Convert from RAW signed 16-bit value to degrees per second
...
// calcAccel(void) -- Convert from RAW signed 16-bit value to gravity (g's).
// This function reads in a signed 16-bit value and returns the scaled
...
// calcMag(void) -- Convert from RAW signed 16-bit value to Gauss (Gs)
// This function reads in a signed 16-bit value and returns the scaled
...
// setGyroScale(void) -- Set the full-scale range of the gyroscope.
...
// setAccelScale(void) -- Set the full-scale range of the accelerometer.
...
// setMagScale(void) -- Set the full-scale range of the magnetometer.
...
// initGyro(void) -- Sets up the gyroscope to begin reading.
...
// initAccel(void) -- Sets up the accelerometer to begin reading.
...
// initMag(void) -- Sets up the magnetometer to begin reading.
...
// gReadByte(void) -- Reads a byte from a specified gyroscope register.
// Input:
...
// gReadBytes(void) -- Reads a number of bytes -- beginning at an address
...
// gWriteByte(void) -- Write a byte to a register in the gyroscope.
// Input:
// - subAddress = Register to be written to.
// - data = data to be written to the register.
void gWriteByte(unsigned char subAddress, unsigned char data);

// xmReadByte(void) -- Read a byte from a register in the accel/mag sensor
// Input:
// - subAddress = Register to be read from.
// Output:
...
// xmReadBytes(void) -- Reads a number of bytes -- beginning at an address
...
// xmWriteByte(void) -- Write a byte to a register in the accel/mag sensor.
// Input:
// - subAddress = Register to be written to.
// - data = data to be written to the register.
void xmWriteByte(unsigned char subAddress, unsigned char data);

// calcgRes(void) -- Calculate the resolution of the gyroscope.
// This function will set the value of the gRes variable. gScale must
// be set prior to calling this function.
void calcgRes(void);

// calcmRes(void) -- Calculate the resolution of the magnetometer.
// This function will set the value of the mRes variable. mScale must
// be set prior to calling this function.
void calcmRes(void);

// calcaRes(void) -- Calculate the resolution of the accelerometer.
...
// SPI Functions //
///////////////////
// initSPI(void) -- Initialize the SPI hardware.
// This function will setup all SPI pins and related hardware.
void SPI_Init(void);

// SPIwriteByte(void) -- Write a byte out of SPI to a register in the device
// Input:
...
// SPIreadByte(void) -- Read a single byte from a register over SPI.
// Input:
// - csPin = The chip select pin of the slave device.
...
// SPIreadBytes(void) -- Read a series of bytes, starting at a register via SPI
// Input:
